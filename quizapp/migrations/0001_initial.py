# Generated by Django 5.2.3 on 2025-08-28 10:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trainer', models.ForeignKey(limit_choices_to={'is_staff': True}, on_delete=django.db.models.deletion.CASCADE, related_name='courses', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='DailyTasks',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.FileField(blank=True, null=True, upload_to='notes/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer', models.FileField(blank=True, null=True, upload_to='task_submissions/')),
                ('submitted_at', models.DateTimeField(auto_now_add=True)),
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submissions', to='quizapp.dailytasks')),
            ],
        ),
        migrations.CreateModel(
            name='Trainer',
            fields=[
                ...
                ('expertise', models.CharField(blank=True, choices=[('HTML Basics', 'HTML Basics'), ('Python Programming Basics', 'Python Programming Basics'), ('General Knowledge', 'General Knowledge'), ('Computer Fundamentals', 'Computer Fundamentals'), ('Advanced Python Programming', 'Advanced Python Programming'), ('CSS', 'CSS'), ('JavaScript', 'JavaScript')], max_length=200, null=True)),
